...
${picture('masthead', 'Worktree Studio routes the current remote default branch into isolated DSH tasks while the primary checkout stays untouched.')}
...
for (const required of ['## Install', '## Use', '## Licence and credit', '.\\setup.ps1', 'docs/usage.md', 'Palaiologos1453/dsh-worktree-studio']) {
