...
Report a vulnerability privately through [GitHub Security Advisories](https://github.com/ryanportfolio/dsh-branchline/security/advisories/new). Do not include credentials, private repository content, or a destructive proof of concept in a public issue.
...
Branchline runs as third-party Host code with the DSH process user's filesystem and Git permissions. Installing it is equivalent to trusting it to create branches, linked worktrees, validation processes, and merge commits in repositories selected through the Web profile.
